...
// --- OFFLINE PROCEDURAL ENEMY GENERATOR ---
// This service creates enemies using randomized lists without any external API calls.
...
export const generateEnemy = async (playerLevel: number): Promise<Enemy> => {
    ...
    const elements: ElementType[] = [
        ...
        'Crystal', 'Steam', 'Spirit', 'Cosmic', 'Sand', 'Magma'
    ];
